    ...
    return (
      <div className="text-center py-12 text-gray-500">
        <p className="text-lg font-medium">
          No authentic regional crafts found.
        </p>
      </div>
    );
  }
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4 max-w-6xl mx-auto">
      {products.map((product) => (
        ...
        >
          ...
          <div className="p-3 flex grow flex-col justify-between">
            <div>
            ...
            <div className="mt-4 flex items-center justify-between">
              <div>
                <span className="text-[10px] block text-gray-400 font-medium uppercase">
                  Price
                </span>
